    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 text-center">
          ...
          <h1 className="text-4xl font-bold mb-6 bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent">
            Random Name Generator
          </h1>
          <p className="text-xl text-gray-700 mb-8">
            This tool is coming soon! Check back later for random name generation.
          </p>
          <Link
            href="/"
